    ...
    def draw(self, screen):
        ...
        if self.__selected:
            if self.__team == 'ally':    
                ...
                screen.blit(health, (self.__x + 10, self.__y - 30))                          #
                ...
                screen.blit(resource, (self.__x + 10, self.__y - 66))                        #

                hp_bar = pygame.Rect((self.__x, self.__y - 36), (300, 34))               #
                pygame.draw.rect(screen, (240,240,240), hp_bar, 2)

                r_bar = pygame.Rect((self.__x, self.__y - 72), (300, 34))                #
